...
class Debugger(object):
  def __init__(self, ipynb=False, theme='black', 
    ...
    if dataset == 'coco_hp':
      ...
      self.num_class = 1
      self.num_joints = 8
      self.edges = [[0, 1], [0, 2], [0, 4], [1, 3], [1, 5], [2, 3], [4, 6], [6, 2], [5, 7], [7, 3]] 
      self.ec = [(0, 255, 255), (255, 0, 0), (0, 0, 255), (255, 0, 0), (0, 0, 255), (0, 255, 255), (128, 0, 128), (128, 128, 128), (128, 0, 128), (128, 128, 128)]
      self.colors_hp = [(0, 255, 0), (255, 0, 0), (0, 0, 255), (255, 255, 0), (255, 0, 255), (0, 255, 255), (0, 128, 255), (255, 128, 0)]
    elif dataset == 'wheel_point':
      self.names = ['p']
      self.num_class = 1
      self.num_joints = 2
      self.edges = [[0, 1]] 
      self.ec = [(0, 255, 255), (255, 0, 0), (0, 0, 255), (255, 0, 0)]
      self.colors_hp = [(0, 255, 0), (255, 0, 0), (0, 0, 255), (255, 255, 0)]
    elif dataset == 'parkspace':
      self.names = ['p']
      self.num_class = 1
      self.num_joints = 4
